...
VkPipeline PipelineBuilder::build_pipeline(VkDevice device) 
{
    ...
    // atm we wont support multiple viewports or scissors
    ...
    // connect the renderInfo tothe pNext extension mechanism
...
void PipelineBuilder::set_input_topology(VkPrimitiveTopology topology)
{
    ...
    // we are not going to use primitive restart on the entire tutorial
...
bool vkutil::load_shader_module(const char* filePath, VkDevice device, VkShaderModule* outShaderModule)
{
    ...
    // codeSize has to be in bytes so multiply the ints in the buffer by the 
    // size of in to know the real size of the buffer
